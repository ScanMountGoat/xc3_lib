...
#[cfg(feature = "xc3")]
impl From<ValueXyz> for xc3_model::shader_database::ValueXyz {
    fn from(value: ValueXyz) -> Self {
        match value {
            ValueXyz::Texture {
                name,
                channel,
                texcoords,
            } => xc3_model::shader_database::ValueXyz::Texture(
                xc3_model::shader_database::TextureXyz {
                    name,
            ...
            ValueXyz::Float(f) => xc3_model::shader_database::ValueXyz::Float(f),
        }
    }
}

#[cfg(feature = "xc3")]
impl From<ChannelXyz> for xc3_model::shader_database::ChannelXyz {
    fn from(value: ChannelXyz) -> Self {
        match value {
            ChannelXyz::Xyz => xc3_model::shader_database::ChannelXyz::Xyz,
            ChannelXyz::X => xc3_model::shader_database::ChannelXyz::X,
            ChannelXyz::Y => xc3_model::shader_database::ChannelXyz::Y,
            ChannelXyz::Z => xc3_model::shader_database::ChannelXyz::Z,
            ChannelXyz::W => xc3_model::shader_database::ChannelXyz::W,
        }
    }
}
