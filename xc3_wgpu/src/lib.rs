...
//!
//! # Getting Started
//! The first step is to initialize an [Xc3Renderer](renderer::Xc3Renderer).
...
//! In each frame, render the models using [Xc3Renderer::render_models](renderer::Xc3Renderer::render_models).
//!
//! ```rust no_run
...
//! let groups = xc3_wgpu::model::load_model(&device, &queue, &[root]);
//!
